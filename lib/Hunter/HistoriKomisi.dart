                              ...
                              content: SingleChildScrollView(
                                child: Column(
                                  ...
                                  children: [
                                    ...
                                    _buildDetail("Harga Barang",currencyFormatter.format(int.tryParse(item['komisiHunter']?.toString() ?? '0') ?? 0)),
                                    _buildDetail("Komisi Hunter (5%)", currencyFormatter.format(int.tryParse(item['komisiHunter']?.toString() ?? '0') ?? 0)),
                                  ],
                                ),
                              ),
                              actions: [

...
class BarangState extends State<Barang> with TickerProviderStateMixin {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        ...
        title: const Text('Beranda', style: TextStyle(fontSize: 26, color: Colors.black)),
        centerTitle: true,
      ),
                    ...
                    child: GridView.builder(
                      ...
                      itemBuilder: (context, index) {
                        ...
                        final imageUrl = images.isNotEmpty
                            ? 'https://reusmart-test.store/${images[0]}'
                            : 'https://reusmart-test.store/k19.jpg';
                              ...
                              builder: (context) {
                                ...
                                for (var img in barang['images']) {
                                  if (img != null && img.toString().isNotEmpty) {
                                    imageList.add('https://reusmart-test.store/$img');
                                  }
                                }
                                return Dialog(
                                      ...
                                      child: Column(
                                        ...
                                        children: [
                                          ...
                                          Align(
                                            alignment: Alignment.centerLeft,
                                            child: Text(
                                              'Periode garansi barang : $periodeGaransi',
                                              style: const TextStyle(
                                                color: Colors.black54,
                                                fontWeight: FontWeight.w600,
                                                fontSize: 18,
